...
public class treeprinter {
    ...
    public static void storestring(String treestring){
    ...
    public static void dobody1(){

        floor=0;
        root=spawntreeStack(input);
        System.out.println(legaltree);
        reset();
        //sendstatus(legaltree);
    }
    public static void dobody2(String treestring){
        storestring(treestring);
        root=spawntreeStack(input);
